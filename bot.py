...
- O'zbek yoshlari internet slangi ishlatasan: "aka", "uka", "voy", "iye", "nima gap", "tasir qilmadi", "sog' bo'l", "o'zi nima", "shunaqami", "ha de", "zo'r-da", "nima deding", "gap yo'q" kabi iboralar
...
def ask_ai(history: list) -> str:
    ...
    chat = ai.start_chat(history=chat_history)
